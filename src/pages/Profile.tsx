      ...
      <section className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated based on your income and tax status</p>
          </div>
          ...
          <div>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg border text-sm font-medium text-left transition-all cursor-pointer ${
                isDependent
            ...
            >
              ...
              {isDependent ? "Yes, I'm claimed as a dependent" : "No, I file independently"}
            </button>
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Affects your federal standard deduction</p>
          </div>
