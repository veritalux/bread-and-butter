      ...
      <section className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 flex items-center gap-2 px-3 py-2.5 rounded-lg border text-sm font-medium transition-all cursor-pointer ${
                  !isDependent
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Used to calculate your estimated tax rate</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated based on your income{isDependent ? " (dependent)" : ""}</p>
          </div>
