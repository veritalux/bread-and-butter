...
import { Save, Check, User, Users } from "lucide-react";
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <User size={15} className={!isDependent ? "text-[var(--color-primary)]" : "text-[var(--color-text-muted)]"} />
                File independently
              </button>
              <button
                type="button"
              ...
              >
                <Users size={15} className={isDependent ? "text-[var(--color-primary)]" : "text-[var(--color-text-muted)]"} />
                Claimed as dependent
              </button>
            </div>
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Can someone else claim you on their tax return?</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated for Salem, OR</p>
          </div>
