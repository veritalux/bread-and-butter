      ...
      <section className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            <label className="block text-xs font-medium text-[var(--color-text-heading)] mb-1.5">Can you be claimed as a dependent?</label>
            <div className="flex gap-2">
              <button
                type="button"
                onClick={() => { setIsDependent(false); setSaved(false); }}
                className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border text-sm font-medium transition-all cursor-pointer ${
                  !isDependent
              ...
              >
                {!isDependent && <Check size={13} className="text-[var(--color-primary)]" />}
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Common for students or young adults on a parent's tax return</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated based on your income and filing status</p>
          </div>
