      ...
      <section className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated (Salem, OR rates)</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Check if someone else claims you on their return</p>
          </div>
