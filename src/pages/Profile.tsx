      ...
      <section className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            <label className="block text-xs font-medium text-[var(--color-text-heading)] mb-1.5">Can someone else claim you as a dependent?</label>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated based on your income and tax situation</p>
          </div>
