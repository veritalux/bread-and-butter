        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex gap-3">
              {[
                { value: false, label: "Independent filer" },
                { value: true, label: "Claimed as dependent" },
              ].map(({ value, label }) => {
                ...
                return (
                  <button
                    ...
                    className={`flex-1 flex items-center gap-2 px-3 py-2.5 rounded-lg border text-xs font-medium text-left transition-all cursor-pointer ${
                      selected
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Used to calculate your standard deduction</p>
          </div>
