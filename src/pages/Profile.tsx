      ...
      <section className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 mb-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="sm:col-span-2">
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Can someone else (e.g. a parent) claim you on their tax return?</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--color-text-muted)] mt-1">Auto-calculated for Salem, OR based on income and filing status</p>
          </div>
