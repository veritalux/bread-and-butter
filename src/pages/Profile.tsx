            ...
            <div className="flex gap-2">
              {([false, true] as const).map((val) => (
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg border text-xs font-medium transition-all cursor-pointer ${
                    isDependent === val
