  ...
  return (
    <>
      <section className="relative overflow-hidden py-20 px-4">
        {/* Glow effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] rounded-full bg-[var(--color-primary)] opacity-[0.07] blur-[120px] animate-glow pointer-events-none" />

        <div className="relative max-w-2xl mx-auto text-center animate-fade-in">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-[var(--color-glow)] text-[var(--color-primary)] border border-[var(--color-primary)]/20 mb-6">
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[var(--color-primary)] text-white font-semibold hover:brightness-110 transition-all shadow-lg shadow-[var(--color-primary)]/20 cursor-pointer"
            >
              <Rocket size={18} />
              Start a Challenge
            </button>
