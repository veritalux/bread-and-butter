            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This affects your standard deduction and estimated tax rate. Common if you're on a parent's tax return.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() => setIsDependent(false)}
                    className={`flex flex-col items-center gap-2 px-4 py-4 rounded-lg border text-sm font-medium transition-all cursor-pointer ${
                      isDependent === false
                  ...
                  >
                    <User size={22} className={isDependent === false ? "text-[var(--color-primary)]" : "text-[var(--color-text-muted)]"} />
                  ...
                  >
                    <Users size={22} className={isDependent === true ? "text-[var(--color-primary)]" : "text-[var(--color-text-muted)]"} />
                    Yes, I'm a dependent
                  </button>
                </div>
              </div>
