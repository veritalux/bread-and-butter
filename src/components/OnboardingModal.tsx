            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This helps us estimate your taxes more accurately. You're a dependent if a parent or guardian claims you on their tax return.
                </p>
                <div className="flex flex-col gap-3">
                  {([
                    { value: false, label: "No — I file independently", sub: "I'm not claimed on anyone else's return" },
                    { value: true, label: "Yes — I'm claimed as a dependent", sub: "A parent or guardian claims me" },
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <div>{label}</div>
                          <div className="text-xs font-normal text-[var(--color-text-muted)] mt-0.5">{sub}</div>
                        </div>
                      </button>
                    );
                  })}
