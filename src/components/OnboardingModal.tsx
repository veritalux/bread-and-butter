            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This affects your standard deduction and helps us estimate your tax rate more accurately.
                </p>
                <div className="flex flex-col gap-3">
                  <button
                    type="button"
                    onClick={() => setIsDependent(true)}
                    className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-lg border text-sm font-medium text-left transition-all cursor-pointer ${
                      isDependent === true
                  ...
                  >
                    ...
                    Yes, I'm claimed as a dependent
                  </button>
                  <button
                    type="button"
                ...
                {isDependent !== null && (
                  <p className="text-xs text-[var(--color-text-muted)] mt-3">
                    Estimated tax rate: <span className="font-semibold text-[var(--color-text)]">{estimateTaxRate(Number(monthlyIncome) || 0, isDependent)}%</span> — based on Salem, OR rates
                  </p>
                )}
              </div>
            )}
