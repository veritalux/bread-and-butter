            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This affects your standard deduction and estimated tax rate. Most people who are claimed on a parent's tax return are dependents.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    { value: true, label: "Yes, I'm a dependent", sub: "e.g. claimed on a parent's return" },
                    { value: false, label: "No, I file independently", sub: "e.g. filing on my own" },
                  ].map(({ value, label, sub }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <div>{label}</div>
                          <div className={`text-xs font-normal mt-0.5 ${selected ? "text-[var(--color-text-muted)]" : "text-[var(--color-text-muted)]/70"}`}>{sub}</div>
                        </div>
                      </button>
                    );
                  })}
