        ...
        <div className="p-6">
          ...
          <div className="mt-6 mb-6">
            ...
            {step === 4 && (
              <div>
                <label className="block text-sm font-medium text-[var(--color-text-heading)] mb-2">
                  Are you a dependent on someone else's tax return?
                </label>
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  For example, if a parent claims you on their taxes. This affects your standard deduction and Oregon state tax.
                </p>
