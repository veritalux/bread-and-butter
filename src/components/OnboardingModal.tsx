...
export default function OnboardingModal({ onComplete }: Props) {
  ...
  const canContinue =
    ...
    step === 4 ? true : // dependent question always continuable
            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This helps us estimate your tax rate more accurately. Dependents have a smaller standard deduction, which affects how much of your income is taxed.
                </p>
