            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This is usually true if you're a student or young adult supported by a parent or guardian. It affects how your federal standard deduction is calculated.
                </p>
