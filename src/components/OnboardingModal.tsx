            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This helps estimate your tax rate more accurately. You're a dependent if someone else (like a parent) can claim you on their tax return.
                </p>
