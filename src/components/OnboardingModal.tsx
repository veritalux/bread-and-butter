            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This is common if a parent or guardian supports you. It affects your standard deduction and estimated tax rate.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    { value: false, label: "No, I file independently" },
                    { value: true, label: "Yes, I'm someone's dependent" },
                  ].map(({ value, label }) => (
                    <button
                      key={String(value)}
                      type="button"
