            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  For example, a parent or guardian claims you on their tax return. This affects your standard deduction and estimated tax rate.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    { value: false, label: "No, I file independently" },
                    { value: true, label: "Yes, I am a dependent" },
                  ].map(({ value, label }) => (
                    <button
                      key={String(value)}
                      type="button"
