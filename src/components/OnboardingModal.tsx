            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This helps us estimate your tax rate more accurately. You're typically a dependent if a parent or guardian claims you — common for students and young adults.
                </p>
