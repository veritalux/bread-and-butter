        ...
        <div className="p-6">
          ...
          <div className="mt-6 mb-6">
            ...
            {step === 4 && (
              <div>
                <label className="block text-sm font-medium text-[var(--color-text-heading)] mb-2">
                  Can someone claim you as a dependent on their taxes?
                </label>
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This is common for students or young adults still on a parent's tax return. It affects how we estimate your tax rate.
                </p>
                <div className="flex flex-col gap-3">
                  ...
                  >
                    ...
                    Yes, I can be claimed as a dependent
                  </button>
                </div>
              </div>
            )}
