...
export default function OnboardingModal({ onComplete }: Props) {
  ...
  const handleSubmit = () => {
    ...
    const dependent = isDependent === true;
    onComplete({
            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  For example, if a parent or guardian claims you on their tax return. This helps us estimate your Salem, Oregon tax rate accurately.
                </p>
