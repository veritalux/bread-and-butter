            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  If a parent or guardian claims you on their tax return, you're a dependent. This helps us estimate your Salem, Oregon tax rate accurately.
                </p>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-normal">I'm claimed on someone else's return</span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="text-xs font-normal">I file independently</span>
                  </button>
                </div>
              </div>
            )}
