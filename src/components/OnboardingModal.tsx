            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This affects your standard deduction, which changes how much of your income is taxed. Most people living with parents or guardians are dependents.
                </p>
                  ...
                  {([true, false] as const).map((val) => {
                    ...
                    return (
                      <button
                        key={String(val)}
                        type="button"
                        onClick={() => setIsDependent(val)}
                        className={`flex flex-col items-center justify-center gap-1.5 px-4 py-5 rounded-lg border text-sm font-semibold transition-all cursor-pointer ${
                          selected
