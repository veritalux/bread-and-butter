            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This helps estimate your tax rate more accurately. Dependents typically have a lower standard deduction, which affects their effective tax rate.
                </p>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mt-3">
                  Most adults answer No. Answer Yes if a parent or guardian claims you on their tax return.
                </p>
              </div>
            )}
