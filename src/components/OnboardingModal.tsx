            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This affects your standard deduction and estimated tax rate.
                </p>
                  ...
                  {([false, true] as const).map((val) => (
                    ...
                    >
                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${
                        isDependent === val ? "border-[var(--color-primary)] bg-[var(--color-primary)]" : "border-[var(--color-border)]"
                      }`}>
                        {isDependent === val && <Check size={12} className="text-[var(--color-primary-foreground)]" />}
                      </div>
                      {val ? "Yes, I am claimed as a dependent" : "No, I file independently"}
                    </button>
                  ))}
                </div>
              </div>
