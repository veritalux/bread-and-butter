            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  For example, a parent claiming you on their tax return. This affects your standard deduction and estimated tax rate.
                </p>
                <div className="flex flex-col gap-3">
                  ...
                  >
                    ...
                    Yes — someone else claims me as a dependent
                  </button>
                </div>
              </div>
            )}
