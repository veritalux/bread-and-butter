            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This helps us estimate your tax rate accurately. You're a dependent if a parent or guardian claims you on their tax return.
                </p>
                <div className="flex flex-col gap-3">
                  {[
                    { value: false, label: "No — I file independently" },
                    { value: true, label: "Yes — I'm claimed as a dependent" },
                  ].map(({ value, label }) => {
