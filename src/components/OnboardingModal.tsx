            ...
            {step === 4 && (
              <div>
                ...
                <p className="text-xs text-[var(--color-text-muted)] mb-4">
                  This is common if you're a student or young adult still supported by a parent or guardian. It affects your standard deduction and estimated tax rate.
                </p>
                <div className="flex flex-col gap-3">
                  <button
                    type="button"
                    onClick={() => setIsDependent(true)}
                    className={`w-full px-4 py-3 rounded-lg border text-sm font-medium text-left transition-all cursor-pointer ${
                      isDependent === true
