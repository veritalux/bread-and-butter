...
// Uses 2024/2025 brackets. Single filer; dependents get a reduced federal standard deduction.
...
export function estimateTaxRate(monthlyIncome: number, isDependent = false): number {
  ...
  // Dependents cannot claim the full standard deduction — IRS limits it to
  // the greater of $1,300 or earned income + $450, capped at the regular amount.
