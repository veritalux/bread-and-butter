...
// Uses 2024/2025 brackets. Single filer unless dependent is specified.
// Dependents have reduced standard deductions per IRS/Oregon rules.
...
// Oregon standard deduction for a dependent is limited to $1,300
const OREGON_DEPENDENT_DEDUCTION = 1300;
...
export function estimateTaxRate(monthlyIncome: number, isDependent = false): number {
  ...
  // Federal standard deduction for dependents: greater of $1,300 or (earned income + $450), capped at regular deduction
